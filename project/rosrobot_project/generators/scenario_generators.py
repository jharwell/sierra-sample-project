...
from sierra.plugins.platform.rosrobot.generators import platform_generators
from sierra.core import utils

# Project packages


class RealWorldScenarioGenerator(platform_generators.PlatformExpDefGenerator):
...
def gen_generator_name(scenario_name: str) -> str:
    res = re.search('RealWorld', scenario_name)
